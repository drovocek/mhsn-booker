...
public interface OpenFilterNotifier extends Serializable {

    default Registration addUIOpenFilterListener(ComponentEventListener<OpenFilterEvent> listener) {
        if (this instanceof Component) {
            return ComponentUtil.addListener(UI.getCurrent(), OpenFilterEvent.class, listener);
        } else {
